...
public class DialogueControls : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Save the number of options available
         //optionSize = optionView.optionsBubble.Count;
        ...
        {
            //options[i] = optionView.[i].GetComponentInChildren<TMPro.TMP_Text>();
        }
    }
    ...
    private void SelectOption()
    {
        ...
        {
            //optionView.SelectOption(currentOption);
            ResetCurrentOption();
        }
    }
